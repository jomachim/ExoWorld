...
class Hud extends GameProcess {
	...
	public function new() {
		...
		notifTw = new dn.Tweenie(Const.FPS);
	...
	public function congrat(str:String,?color:UInt=0xffffff){
		// Bg
		var t = Assets.tiles.getTile( D.tiles.uiBarBg );
		...
		f.paddingLeft = 9;
		f.y = 4;
		//f.x = Std.int( w()/Const.UI_SCALE*0.5 );
